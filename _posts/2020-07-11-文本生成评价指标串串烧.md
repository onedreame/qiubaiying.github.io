...
![BLEU](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/BLEU.png)
...
![image-20200711163442033](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/改进的多元精度.png)
...
- ROUGE-N （将BLEU的精确率优化为召回率）
  ...
  ![image-20200711175547376](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711175547376.png)

  公式的分母是统计在参考译文中 N-gram 的个数，而分子是统计参考译文与机器译文共有的 N-gram 个数。

  仍以表1说明其计算方法：

  ![image-20200711175909036](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711175909036.png)

  针对多个参考译文，最终的ROUGE分数为计算机译文和这些参考译文的 ROUGE-N 分数的最大值，计算方式为：

   ![image-20200711180032595](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711180032595.png)

- ROUGE-L （将BLEU的n-gram优化为公共子序列）

  后缀L代表最长公共子序列(longest common subsequence, LCS)，见名知义，它统计的是机器译文C和参考译文S的最长公共子序列，计算公式为：

  ![image-20200711180507753](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711180507753.png)
...
- ROUGE-W （将ROUGE-L的连续匹配给予更高的奖励）
  ...
  ![image-20200711181043107](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711181043107.png)
...
- ROUGE-S  （允许n-gram出现跳词(skip)）
  ...
  ![image-20200711181457020](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711181457020.png)

  则计算公式为：

  ![image-20200711181519855](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711181519855.png)
...
<img src="/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711182211739.png" alt="image-20200711182211739" style="zoom:150%;" />
...
![image-20200711182403970](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711182403970.png)
...
- β是一个常数，在Lsys/Lref=2/3 时，β使得长度罚分率为0.5，它是个经验值，大概的曲线是：
  ...
  ![image-20200711182521612](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711182521612.png)
...
![image-20200711205959078](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711205959078.png)
...
![image-20200711210631669](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711210631669.png)
...
![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/CIDEr.png)

举例：

![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/CIDEr_example.png)
...
![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/SPICE_example1.png)
...
![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/SPICE_example2.png)

​	得到了若干个三元组之后，我们通过下面的公式来计算候选句c和参考句（或集合）S的得分：

![image-20200711212158091](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/image-20200711212158091.png)

另一个栗子：

![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/SPICE_example3.png)
...
![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/greedy_matching.png)
...
![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/embedding_average.png)
...
![ppl](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/ppl.png)
...
![img](/Users/txyk/Documents/onedreame.github.io/img/文本生成指标/BERTSCORE.png)
